    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duree_projet', models.IntegerField(default=0, verbose_name='Duree Estime')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time_allocated_by_member', models.IntegerField(verbose_name='Temps alloué par etudiant')),
